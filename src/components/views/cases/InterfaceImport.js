...
export default createReactClass({
    ...
    _onPinChanged: function(e) {
        this.setState({pin: e.target.value});
    },

    _onPatientChanged: function(e) {
        this.setState({
            ...
            return <div>
                <div className="amp_CaseTab_section">
                    ...
                    <Field id="password" className="amp_CreateCaseDialog_input_field"
                        ...
                        />
                    <AccessibleButton className="amp_CreateCaseImportButton" onClick={this._loginPassword} kind="primary">
                        {_t("Login")}
                    </AccessibleButton>
                </div>
            ...
            return <div>
                <div className="amp_CaseTab_section">
                    <Field id="pin" className="amp_CreateCaseDialog_input_field"
                        ...
                        autoComplete="off"
                        type="text"
                        onChange={this._onPinChanged}
                        value={this.state.pin}
                        />
                    <AccessibleButton className="amp_CreateCaseImportButton" onClick={this._loginPin} kind="primary">
                        {_t("Login")}
                    </AccessibleButton>
                </div>
                <span className="amp_CreateCaseDialog_error">{this.state.error}</span>
    ...
    _renderPatientData: function() {
      ...
      return <div>
            ...
            <table><tbody>
              <tr>
                <td><input type="checkbox" onChange={this._onNameToggled} checked={this.state.nameSelected} /></td>
                <td>{_t("Name")}</td>
                <td>{this.state.patientData.name}</td>
              </tr>
              <tr>
                <td><input type="checkbox" onChange={this._onGenderToggled} checked={this.state.genderSelected} /></td>
                <td>{_t("Gender")}</td>
                <td>{_t(this.state.patientData.gender)}</td>
              </tr>
              <tr>
                <td><input type="checkbox" onChange={this._onBirthdayToggled} checked={this.state.birthdaySelected} /></td>
                <td>{_t("Birthday")}</td>
    ...
    _renderVitalData: function() {
      ...
      return <div><h3>{_t("Vital data")}</h3>
        <table><tbody>
          <tr>
            <td><input type="checkbox" onChange={this._onBPToggled} checked={this.state.bloodpressureSelected} /></td>
          ...
          <tr>
            <td><input type="checkbox" onChange={this._onPulseToggled} checked={this.state.pulseSelected} /></td>
            <td>{_t("Pulse")}</td>
          ...
          <tr>
            <td><input type="checkbox" onChange={this._onTempToggled} checked={this.state.temperatureSelected} /></td>
          ...
          <tr>
            <td><input type="checkbox" onChange={this._onSugarToggled} checked={this.state.sugarSelected} /></td>
          ...
          <tr>
            <td><input type="checkbox" onChange={this._onWeightToggled} checked={this.state.weightSelected} /></td>
            <td>{_t("Weight")}</td>
          ...
          <tr>
            <td><input type="checkbox" onChange={this._onSpo2Toggled} checked={this.state.spo2Selected} /></td>
        ...
        <AccessibleButton className="amp_CreateCaseImportButton" onClick={this._onOk} kind="primary">
            {_t("Import data")}
        </AccessibleButton>
        </div>;
    },
        ...
        return (
            <div className="amp_Dialog_content">
                ...
                <div>
                    ...
                    <div className="amp_CaseTab_section">
                        {this._renderPatientData()}
                    </div>
                    <div className="amp_CaseTab_section">
                        {this._renderVitalData()}
                    </div>
                </div>
            </div>
        );
