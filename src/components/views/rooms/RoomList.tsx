...
const TAG_AESTHETICS: {
    ...
    [DefaultTagID.DM]: {
        sectionLabel: _td("Cases"),
        isInvite: false,
        defaultHidden: false,
        addRoomLabel: _td("New case"),
        onAddRoom: (dispatcher?: Dispatcher<ActionPayload>) => {
            (dispatcher || defaultDispatcher).dispatch({action: 'view_create_case'});
        },
    },
    [DefaultTagID.Untagged]: {
        sectionLabel: _td("Anonymous cases"),
        isInvite: false,
        defaultHidden: false,
        addRoomLabel: _td("New anonymous case"),
        onAddRoom: (dispatcher?: Dispatcher<ActionPayload>) => {
