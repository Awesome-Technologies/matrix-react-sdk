...
export default class RoomView extends React.Component<IProps, IState> {
    ...
    private onAction = payload => {
        switch (payload.action) {
            ...
            case 'message_sent':
                ...
                this.checkIfCaseClosed(this.state.room);
                break;
    ...
    private checkIfCaseClosed(room: Room) {
        ...
        for (let i=room.timeline.length-1; i >= 0; i--) { // search reverse as the done event should be near the end
            ...
            if (room.timeline[i].event.type === 'care.amp.done') {
                ...
                return;
            } else if (room.timeline[i].event.type === 'm.room.encrypted'
                        && room.timeline[i]._clearEvent.type === 'care.amp.done') {
    ...
    render() {
        ...
        const casePanel = (
            <CasePanel ref={this.gatherTimelinePanelRef}
                timelineSet={this.state.room.getUnfilteredTimelineSet()}
