...
const CasePanel = createReactClass({
    ...
    render: function() {
        const CaseObservationsPanel = sdk.getComponent("structures.CaseObservationsPanel");
        ...
        const stickyBottom = false;
        const startAtBottom = false;
        ...
        return (
            <CaseObservationsPanel ref="caseObservations"
